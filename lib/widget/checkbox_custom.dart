...
///  * [Switch], a widget with semantics similar to [MeeyCheckbox].
      ...
      child: Builder(
        builder: (BuildContext context) {
          return _CheckboxRenderObjectWidget(
            ...
            activeColor:const Color(0xff326fe3),
            checkColor: widget.checkColor ?? const Color(0xFFFFFFFF),
            // inactiveColor: enabled ? themeData.unselectedWidgetColor : themeData.disabledColor,
            // inactiveColor: enabled ?const Color(0xff326fe3) : themeData.disabledColor,
            inactiveColor:const Color(0xff326fe3),
...
const Radius _kEdgeRadius = Radius.circular(3.0);
...
class _RenderCheckbox extends RenderToggleable {
  ...
  void _drawBorder(Canvas canvas, RRect outer, double t, Paint paint) {
    ...
    canvas.drawDRRect(outer, inner, paint..color= Color(0xff326fe3));
  }
